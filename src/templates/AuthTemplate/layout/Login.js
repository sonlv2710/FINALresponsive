...
import { postDangNhap } from '../../../redux/services/QuanLyNguoiDungSevices/QuanLyNguoiDungSevices';
...
const Login = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            console.log(values);
            try {
                const res = await postDangNhap(values.taiKhoan, values.matKhau);
                // console.log(">>>><<<<<", res);
            ...
            <div className="lg:w-1/2 xl:max-w-screen-sm">
                <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div className="cursor-pointer flex items-center">
                        ...
                        <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">GALAXY</div>
                    </div>
                </div>
                    ...
                    <div className="mt-12">
                      ...
                      shadow-lg">
                        ...
                        <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Don't have an account ? <Link className="cursor-pointer text-indigo-600 hover:text-indigo-800" to="/auth/register">Sign up</Link>
                        </div>
                    </div>
                </div>
            </div>
